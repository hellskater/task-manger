...
function UpdateModal({ closeModal, callbackParent, id }) {
  ...
  return (
    <div className="updateModal">
      <Button onClick={closeModal} className="updateModal__close">
        <ClearIcon />
        Close
      </Button>

      <form>
        <div className="updateModal__message">
        ...
        <div className="updateModal__duedate">
        ...
        <div className="updateModal__user">
        ...
        <div className="updateModal__priority">
        ...
        <div className="updateModal__submit">
